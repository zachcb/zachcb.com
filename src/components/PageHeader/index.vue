<template>
  <header :class="[{
    ...
    <div class="w-full relative flex justify-between items-center py-2 z-50">
      <g-link to="/" class="logo relative px-2 text-4xl font-black uppercase italic leading-loose">
        <span>Z</span>
      </g-link>
